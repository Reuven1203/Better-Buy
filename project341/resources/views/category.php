    ...
    <header class="header_area">
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    <a class="navbar-brand logo_h" href="index.html"><img src="img/BetterBuy_logo2.png" alt="" width="200" height="100"></a>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-4">
                                <div class="card text-center card-product">
                                    ...
                                    <div class="card-body">
                                        <p>Electronics</p>
                                        <h4 class="card-product__title"><a href="Categories_Laptop.html">Laptops</a></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4">
                                <div class="card text-center card-product">
                                    ...
                                    <div class="card-body">
                                        <p>Electronics</p>
                                        <h4 class="card-product__title"><a href="Categories_Phone.html">Phones</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
